...
Model_DIR = '/Users/divyachandana/Documents/NJIT/work/NeuroTPR'
...
if __name__ == '__main__':
    ...
    testSentences = readfile("./data/HarveyTweet1000.txt")
    ...
    if embedding_choice == 0:
        fEmbeddings = open("./data/glove.twitter.27B.200d.txt", encoding="utf-8")
    else:
        fEmbeddings = open("./data/glove.6B.300d.txt", encoding="utf-8")
